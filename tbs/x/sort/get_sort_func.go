...
// This version hardcodes the functionality currently derived from reflect.
// That is, it doesn't use reflect.ValueOf or reflect.Swapper.
...
// This version uses the current implementation of sort.Slice.
...
// Everything below this line is copied from the sort package.
